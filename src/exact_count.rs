...
fn count_kmers_in_fasta_file_par(
    file_name: String,
    ...
    input_rx
        ...
        .try_for_each(move |mut chunk| {
            for (record, nb_shared_kmers) in &mut chunk.records {
                ...
                *nb_shared_kmers = Some(count_shared_kmers_par(
                    kmer_set,
                    record.seq(),
                    kmer_size,
                    stranded,
