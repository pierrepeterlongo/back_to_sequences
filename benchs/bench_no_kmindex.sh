...
do
    ...
    time ./disk_mem_count.sh back_to_sequences exact_count --in_kmers compacted_kmers.fasta --in_fasta reads_${nb_reads}.fasta  --out_fasta filtered_reads_exact_${nb_reads}.fasta  -k 31 --out_counted_kmers counted_kmers_${nb_reads}_no_kmindex.txt
done
