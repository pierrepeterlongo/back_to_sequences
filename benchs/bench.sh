...
echo "Indexing kmers"
time ~/bin/disk_mem_count.sh back_to_sequences index_kmers --in_kmers fof.txt --out_index indexed_kmers -k 31 
...
do
    ...
    time ./disk_mem_count.sh back_to_sequences query_sequences --in_sequences reads_${nb_reads}.fasta --in_kmer_index indexed_kmers --out_fasta filtered_reads_${nb_reads}.fasta -t 32
